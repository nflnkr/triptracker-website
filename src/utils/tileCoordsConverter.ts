...
export function getTileCoordByZoomLevel(coord: number, initialZoomLevel: number, targetZoomLevel: number) {
    return coord * Math.pow(2, targetZoomLevel - initialZoomLevel);
}